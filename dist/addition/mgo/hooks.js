...
async function create(name, _ref2) {
  let {
    items
  } = _ref2;
...
async function softDelMany(name, _ref3) {
  let {
    cond
  } = _ref3;
...
async function softDelOne(name, _ref4) {
  let {
    cond
  } = _ref4;
...
async function updateMany(name, _ref5) {
  let {
    cond,
    doc
  } = _ref5;
...
async function updateOne(name, _ref6) {
  let {
    cond,
    doc
  } = _ref6;
...
module.exports = {
  ...
  softDelMany: function (name) {
    return async function (ctx) {
      try {
        ...
        const result = await softDelMany(name, {
          cond
        });
        ctx.body = {
          errcode: null,
  ...
  softDelOne: function (name) {
    return async function (ctx) {
      try {
        const cond = ctx.request.body;
        const result = await softDelOne(name, {
          cond
        });
        ctx.body = {
          errcode: null,
  ...
  updateMany: function (name) {
    return async function (ctx) {
      try {
        ...
        const result = await updateMany(name, {
          cond,
          doc
        });
        ctx.body = {
