...
async function fakeVerify(reqPath, _ref) {
  let {
    fakeTokens,
    fakeUrls,
    accessToken
...
module.exports.prototype.authToken = async function (accessToken) {
  const {
    findToken
  } = this.options;
...
module.exports.prototype.plugin = function (_ref3) {
  let {
    router
  } = _ref3;
  const {
